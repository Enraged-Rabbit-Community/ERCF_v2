...
`force_form_tip_standalone: 1` this tell Happy Hare to always use the tip cutting macro. See [Happy Hare's slicer guide](https://github.com/moggieuk/Happy-Hare/blob/main/doc/toolchange_movement.md#turning-off-slicer-tip-forming).  
