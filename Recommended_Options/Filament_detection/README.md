...
✔ physical clogg detection between ERCF and Extruder (It is detected whether the filament is fed to the toolhead extruder.)  
✘ no clogg detection after Extruder (No detection whether the filament is being fed by the toolhead extruder into the nozzle.)  
...
✘ no clogg detection between after and Nozzle (No detection whether the filament is being fed the toolhead extruder into the nozzle.)  
**not recommended**
