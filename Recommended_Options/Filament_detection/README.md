...
✔ physical clogg detection after Extruder and Nozzle (It is detected whether the filament is being fed by the toolhead extruder.)   
...
✘ no clogg detection  between ERCF and Extruder (It is software detected whether the filament is fed to the toolhead extruder.)  
✔ physical clogg detection between Extruder and Nozzle (It is detected whether the filament is being fed by the toolhead extruder.)  
