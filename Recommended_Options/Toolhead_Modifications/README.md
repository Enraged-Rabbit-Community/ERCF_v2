...
> For users who have integrated the ERF filament cutter into their systems, please refer to the toolhead modifications outlined in then [ERF Filament Cutter](../ERF_Filament_Cutter) section where you will find a similar set of toolhead modifications but including the cutting option.
...
✘ smooth bowden loading (this system relies on collision detection when the filament hits the extruder)
✘ precise extruder loading
